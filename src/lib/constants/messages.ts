export const ERROR_MESSAGES = {
  ACCESS_DENIED: (path: string) => `Error: Access denied. Path "${path}" is not within the allowed domain.`,
  ...
  COMMAND_EXEC_ERROR: (msg: string, stdout: string, stderr: string) => `Execution Error:\n${msg}\n\nSTDOUT:\n${stdout}\n\nSTDERR:\n${stderr}`,
