...
export const UnsupportedViewer: React.FC<{ file: FileInfo }> = ({ file }) => (
  <UnifiedViewer padding="p-8">
    <div className="flex items-center justify-center min-h-full">
      <div className="max-w-md w-full bg-sidebar border border-border p-8 rounded-2xl shadow-xl flex flex-col items-center text-center gap-6">
        ...
        <div>
          <h3 className="text-lg font-semibold text-foreground mb-2">Unsupported File Type</h3>
          <p className="text-sm text-muted-foreground mb-6">Aynite doesn't support direct preview for this file type yet.</p>
