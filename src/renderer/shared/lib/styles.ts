...
/** Two-column grid layout for settings panels */
export const GRID_2_COL = 'grid grid-cols-2 gap-4'

/** Flex row with centered items and small gap */
export const FLEX_CENTER_GAP_1 = 'flex items-center gap-1.5'

/** Flex row with centered items and standard gap */
...
/** Flex row with items centered and spaced between */
export const FLEX_CENTER_BETWEEN = 'flex items-center justify-between'
