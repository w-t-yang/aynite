      ...
      <div className={cn(
        ...
        <div className="flex items-center gap-3">
          <div className={cn(
            ...
            {updateStatus === 'checking' && <RefreshCw size={18} className="animate-spin" />}
            {updateStatus === 'available' && <Download size={18} />}
            {updateStatus === 'downloading' && <Download size={18} className="animate-bounce" />}
        ...
        {isError ? (
          ...
          <p className="text-xs text-muted-foreground truncate px-1">
            {updateStatus === 'downloaded' ? 'Restart to apply changes' : 'Aynite Release Pipeline'}
          </p>
        )}
