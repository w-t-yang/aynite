import type { DataViewStock } from './types'
...
export const calculateVWAP = (data: DataViewStock[]): number[] => {
...
export const calculateDonchian = (data: DataViewStock[], period: number) => {
...
export const calculateMACD = (data: DataViewStock[]) => {
...
export const calculateSAR = (data: DataViewStock[]): number[] => {
...
export const enrichDataWithIndicators = (
  data: DataViewStock[],
): DataViewStock[] => {
...
export const aggregateData = (
  ...
  const groups: { [key: string]: DataViewStock[] } = {}
  data.forEach((d) => {
    const key = getKey(d)
