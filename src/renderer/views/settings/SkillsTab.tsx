  ...
  return (
    ...
    >
      ...
      <Section
        ...
        description="A list of all skills found and parsed from your folders."
      >
      ...
      >
        <p className="text-sm text-muted-foreground">
          ...
          ? The assistant will no longer be able to use skills from this
          directory.
        </p>
      </Modal>
    </SettingsPage>
